...
insert into product (description,image, name, price, product_id,id) values ('description','apple.jpg',  'apple', 5.4, 1,1);
insert into product (description,image, name, price, product_id,id) values ('description','ball.jpg', 'ball', 12.8, 1,2);
insert into product (description,image, name, price, product_id,id) values ('description','pen.jpg', 'pen', 3.5, 2,3);
